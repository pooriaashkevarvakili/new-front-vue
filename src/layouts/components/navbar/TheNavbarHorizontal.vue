      ...
      <vs-navbar class="navbar-custom navbar-skelton" :class="navbarClasses" :style="navbarStyle" :color="navbarColor">
        ...
        <template v-if="windowWidth >= 992">
                ...
                <ul class="vx-navbar__starred-pages-more--list">
                  <draggable v-model="starredPagesMore" :group="{name: 'pinList'}" class="cursor-move">
                    <li class="starred-page--more flex items-center cursor-pointer" v-for="page in starredPagesMore"
                        :key="page.url" @click="$router.push(page.url).catch(() => {})">
          ...
          <div class="bookmark-container">
            <feather-icon icon="StarIcon" svgClasses="stoke-current text-warning" class="cursor-pointer p-2"
        ...
        <router-link tag="div" to="/" class="vx-logo cursor-pointer mx-auto flex items-center">
          ...
          <span class="vx-logo-text">Hacoupian</span>
        </router-link>

        <!-- SEARCHBAR -->
        <div class="search-full-container w-full h-full absolute left-0" :class="{'flex': showFullSearch}"
        ...
        <feather-icon icon="SearchIcon" @click="showFullSearch = true"
                      class="cursor-pointer navbar-fuzzy-search mr-4"></feather-icon>
        ...
        <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
          ...
          <vs-dropdown-menu class="notification-dropdown dropdown-custom vx-navbar-dropdown">
            ...
            <PerfectScrollbar ref="mainSidebarPs" class="scroll-area--nofications-dropdown p-0 mb-10"
                              :settings="settings">
