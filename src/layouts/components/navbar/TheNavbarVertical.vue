      ...
      <vs-navbar class="vx-navbar navbar-custom navbar-skelton" :color="navbarColorLocal">
        ...
        <template v-if="windowWidth >= 992">
          ...
          <ul class="vx-navbar__starred-pages">
            <VueDraggableNext v-model="starredPagesLimited" :group="{name: 'pinList'}" class="flex cursor-move">
            ...
            <vs-dropdown vs-custom-content vs-trigger-click>
              ...
              <vs-dropdown-menu>
                <ul class="vx-navbar__starred-pages-more--list">
                  <VueDraggableNext v-model="starredPagesMore" :group="{name: 'pinList'}" class="cursor-move">
