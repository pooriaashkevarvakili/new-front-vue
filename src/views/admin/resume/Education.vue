/* ---------------------------------- HACOUPIAN 360  ---------------------------------- *
- Author(s): AraNote
- Date Created: 1400/06/22-13:47
- ------------------------------------------------------------------------------------ *
- This file is more Filter of job offer module.
- All of the فیلتر های بیشتر بخش تحصیلات Application manage by this .
- original
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
       ...
       * @alpha  مراحل مودال تحصیل در فیلترهای بیشتر arshive resume
       * @beta types eduction modal
       * @example زیردیپلم تا دکترا
       * @returns set value education state vuex vue
       */
